<!DOCTYPE html>
  ...
  var wsUri = "wss://" + window.location.hostname + "/websocket";
        var output;
        var websocket;
        ...
        function onOpen(evt)
        {
            emit("SOCKET OPENED");
            sendTextFrame());
            //sendTextFrame(JSON.stringify({"userAuth":"6ijfi5t48acb7gikir8j1ptcrl"}));
        }
        ...
        function clickSend()
        {
            ...
            {
                sendTextFrame(JSON.stringify({"message": txt.value}));
                txt.value = "";
                txt.focus();
            }
        }
