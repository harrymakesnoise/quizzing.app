...
$footerScripts .= '
  ...
  var canAddAllAnswers = true;
  function updateCorrectAnswers() {
    var outData = {};
    var selectData = {}
    
    canAddAllAnswers = false;
    $("#btn-qa-ca").html("<i class=\'fa fa-sync fa-spin\'></i>");
    ...
    $(\'input[name="questionanswer[]"]\').each(function() {
      ...
      outData[count] = {"label": $(this).val(), "value": $(this).val(), "selected": selected};
      count++;
    });
    ...
    updateAnswerType();
    canAddAllAnswers = true;
    $("#btn-qa-ca").html("All Question Answers &nbsp;&nbsp;<i class=\'fas fa-arrow-right\'></i>&nbsp;&nbsp; Correct Answers");
  }

  function updateAnswerType() {
    var correctAnswers = $("#questioncorrect").select2("data");
    var availableAnswers = $(\'input[name="questionanswer[]"]\');
    console.log(correctAnswers);
    console.log(availableAnswers);
    if(Object.keys(correctAnswers).length < availableAnswers.length) {
      answerType = "Multiple choice";
    } else {
      answerType = "Text-box";
    }
    $("#answerTypeMsg").html(answerType);
  }
  ...
  function allAnswersCorrect() {
    ...
    $("#questioncorrect option[value]").prop("selected", true);
    $("#questioncorrect").trigger("change");
  }

  $(document).ready(function() {
    $("#btn-qa-ca").css("width", $("#btn-qa-ca").outerWidth());
  });
  </script>';
$footerScripts .= '
<!-- Bootstrap 4 -->
...
<script>$(".select2bs4").select2({theme: "bootstrap4"});$("#questioncorrect").on("change", updateAnswerType);</script>';
renderSiteHeader();
?>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <p><span id="answerTypeMsg">Loading...</span></p>
                  </div>
                  <?/*
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <br />
                    <button onClick="allAnswersCorrect(); return false;" id="btn-qa-ca" class="btn btn-info">All Question Answers &nbsp;&nbsp;<i class="fas fa-arrow-right"></i>&nbsp;&nbsp; Correct Answers</button>
                  </div>
                </div>
              </div>
              <!-- /.card -->
