...
if(getCleanRequestParam('process') != '') {
  $class = new QuizCategory();
  if($class->createEdit($categoryID, $quizSite->siteid)) {
...
$selectedQuizQuestion = new QuizCategory($setcategoryID, $loadQuestion);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?=($filter == 'new' ? 'Create Category' : 'Edit Category')?></h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="categoryname" name="categoryname" placeholder="" value="<?=$questionLabel?>">
                  </div>
                  <div class="form-group">
                    <label for="categoryDesc">Category Description</label>
                    <input type="text" class="form-control" id="categoryDesc" name="categorydescription" placeholder="" value="<?=$questionLabel?>">
                  </div>
                  <div class="form-group">
                    <label for="categoryIcon">Category Icon</label>
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                        <button class="btn btn-disabled btn-info" onClick="return false;"><span class="demo-icon"></button>
                      </div>
                      <input type="text" class="icon-class-input form-control" value="<?=$questionLabel?>" />
...
$('.picker-button').click(function() {
  ...
  iconInput = $(this).parent().parent().find('.icon-class-input');
...
$('#change-icon').click(function() {
  ...
  iconInput.parent().parent().find('.demo-icon').attr('class', 'demo-icon');
  iconInput.parent().parent().find('.demo-icon').addClass(icons[selectedIcon].icon);
